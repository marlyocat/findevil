...
flowchart TB
    ...
    subgraph Findevil[Findevil MCP Server stdio subprocess]
        ...
        mcp["FastMCP instance<br/>43 typed tools"]
        ...
        subgraph Tools[Tool modules — 13 domain groups]
            direction TB
...
The full table — 43 typed `@mcp.tool()` functions across 13 modules —
lives in [the project README](../README.md#tool-inventory-43). The
